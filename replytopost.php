<?php
 ...
 <h1 style="margin-left: 26%">Post Your Reply in <u><?php echo $topic_title; ?></u></h1>
 <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
 <p><label  style="margin-left: 25%" for="post_owner">Your Email Address:</label><br/>
 <input type="email" id="post_owner" name="post_owner" size="40"
 maxlength="150" required="required"></p>
 <p><label  style="margin-left: 25%" for="post_text">Post Text:</label><br/>
...
margin: 4px 2px;
margin-left: 44%;" type="submit" name="submit" value="submit">Add Post</button>
 </form>
</div>
 </body>
 </html>
